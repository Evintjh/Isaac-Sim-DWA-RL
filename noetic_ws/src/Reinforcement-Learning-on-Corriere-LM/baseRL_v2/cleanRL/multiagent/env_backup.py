...
class JackalEnv(gym.Env):
    ...
    def __init__(
        ...
        self.jackal_articulation = ArticulationView(prim_paths_expr="/envs/*/jackal", name="jackal_view",reset_xform_properties=False)
        self.jackal_articulation = self._my_world.scene.add(self.jackal_articulation)
